 ...
 *
 * Implementing Hashmap as a GameBoardMap class object with additional
 ...
 */
 ...
 public class GameBoardMap<K,V> extends HashMap{
    ...
    public static void main (String [] args){
        GameBoardMap <Integer, Integer> map1 = new GameBoardMap<>();
        GameBoardMap <Integer, Integer> map2 = new GameBoardMap<>();
        GameBoardMap <Integer, Integer> map3 = new GameBoardMap<>();
